...
namespace ops_wrapper {
  ...
  extern void ops_wrapper_init(void) noexcept(false);

  //  set key for otm.
  extern void ops_wrapper_otm_key(unsigned short);

  // set key for base64.
  //  void ops_wrapper_base64_key(unsigned short);

  extern void ops_wrapper_xor_key(uint8_t);
